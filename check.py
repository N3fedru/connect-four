def winner(arr, y_axis, x_axis):
    ...
    def check(y, x):
        ...
        # variables
        arr_x = [[[y, 0], [y, 1], [y, 2], [y, 3]], [[y, 1], [y, 2], [y, 3], [y, 4]], [
            [y, 2], [y, 3], [y, 4], [y, 5]], [[y, 3], [y, 4], [y, 5], [y, 6]]]
        arr_diagonal = []  # diagonal
        array = []
        arr = []
        ...
        # diagonal
        diagonal(array, y, x, -1, -1)
        array = array[::-1]
        array.append([y, x])
        diagonal(array, y, x, 1, 1)
        dig_lst(array, arr_diagonal, arr)
        array = []
        arr_diagonal = []
        diagonal(array, y, x, -1, 1)
        array = array[::-1]
